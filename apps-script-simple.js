...
// ============================================
//
// ĐƠN GIẢN NHẤT: Frontend gửi base64 → Apps Script save Drive + add Sheet
// Không cần Cloudflare, không cần backend phức tạp!
//
// SETUP (3 phút):
// 1. Vào Google Sheet: https://docs.google.com/spreadsheets/d/1L5uPWT-44HeOhFIDBZywS6JolM7BBgQHfmN2FzRaGsU/edit
// 2. Extensions → Apps Script
// 3. Xóa code cũ, paste code này
// 4. Save → Deploy → New deployment → Web app
// 5. Execute as: Me, Who has access: Anyone
// 6. Deploy → Authorize → Copy Web App URL
// 7. Paste URL vào car-game.html MY_CARS_CONFIG.UPLOAD_URL
//
// ============================================
  ...
  const testData = {
    postData: {
      contents: JSON.stringify({
        photo: '/9j/4AAQSkZJRg...',  // base64 test image
        nameEn: 'Test Car',
